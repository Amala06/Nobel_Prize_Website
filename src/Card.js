      ...
      const fun=()=>{
        if(id==="1"){
            ...
            setDesc(
              ...
              setDesc(
                "They collectively received the Nobel Prize in Physics in 1972 for their jointly developed theory of superconductivity, usually called the BCS-theory.They collectively received the Nobel Prize in Physics in 1972 for their jointly developed theory of superconductivity, usually called the BCS-theory.They collectively received the Nobel Prize in Physics in 1972 for their jointly developed theory of superconductivity, usually called the BCS-theory.They collectively received the Nobel Prize in Physics in 1972 for their jointly developed theory of superconductivity, usually called the BCS-theory.They collectively received the Nobel Prize in Physics in 1972 for their jointly developed theory of superconductivity, usually called the BCS-theory."
              );
            }
            else  if (id === "4") {
